<div class="col-lg-12">
<div class="card">
    <form action="danhmucbv/addsave" method="post" enctype="multipart/form-data">
   <div class="card-header"><strong>Thêm mới</strong><small> Danh mục bài viết</small></div>
   <div class="card-body card-block">
      ...
      <div class="row form-group">
         ...
         <div class="col-6">
            <div class="form-group"><label for="postal-code" class=" form-control-label">Thứ tự</label><input type="text" name="vi_tri" placeholder="Thứ tự" class="form-control"></div>
         </div>
      </div>
      <div class="row form-group">
         <div class="col-6">
