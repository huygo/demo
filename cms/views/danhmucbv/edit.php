<div class="col-lg-12">
<div class="card">
    <form action="danhmucbv/editsave?id=<?php echo $this->data['id']; ?>" method="post" enctype="multipart/form-data">
   <div class="card-header"><strong>Cập nhập</strong><small> Danh mục bài viết</small></div>
   <div class="card-body card-block">
      ...
      <div class="row form-group">
         ...
         <div class="col-3">
            <div class="form-group"><label for="postal-code" class=" form-control-label">Thứ tự</label><input type="number" name="vi_tri" placeholder="Thứ tự" value="<?php echo $this->data['thu_tu']; ?>" class="form-control"></div>
         </div>
      </div>
      <div class="row form-group">
         <div class="col-6">
